...
public class EmployeesDao {
    ...
    //Variable para enviar tados entre interfaces
    ...
    //Modificar Empleado
    public boolean updateEmployyeQuery(Employees employee){
        String query = "UPDATE employyes SET full_name =?, username =?,"
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Error al modificar el empleados: "+e);
            return false;
        }
    }
    ...
    public boolean deleteEmployeeQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Nose puede eliminar un empleado que tenga relacion"
            +"con otra tabla"+e);
            return false;
        }
    }
    ...
    public boolean deleteEmployeePassword(Employees employee){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, " Ha ocurrido un error al querer modificar el Password:"
            +""+e);
            return false;
        }
    }
