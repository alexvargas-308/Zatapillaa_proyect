...
public class Purchases {
    ...
    private float purchase_subtotal;
    private float total;
    ...
    public Purchases(int id, int code, String product_name, int purchase_amount, float purchase_price, float purchase_subtotal, float total, String created, String supplier_name_product, String purchase) {
        this.id = id;
        this.code = code;
    ...
    public float getPurchase_subtotal() {
        return purchase_subtotal;
    }

    public void setPurchase_subtotal(float purchase_subtotal) {
        this.purchase_subtotal = purchase_subtotal;
    }
